...
function addApartment(txtPropertyType, txtBedroom, txtCurrentDateTime, txtMonthlyPrice, cbxFurnitureType1, cbxFurnitureType2, cbxFurnitureType3, txtNote, txtReporterName) {
    var db = openDatabase('RentalApartmentDatabase', '1.0', 'Database for RentalZ app', 2 * 1024 * 1024);
    db.transaction(function(tx) {
        ...
        tx.executeSql(sql, [txtPropertyType, txtBedroom, txtCurrentDateTime, txtMonthlyPrice, cbxFurnitureType1, cbxFurnitureType2, cbxFurnitureType3, txtNote, txtReporterName]);
    });
}
